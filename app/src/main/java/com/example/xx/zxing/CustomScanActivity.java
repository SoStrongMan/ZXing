...
public class CustomScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //为二维码扫描界面设置定制化界面
        CodeUtils.setFragmentArgs(captureFragment, R.layout.fragment_custom_scan);
        ...
        ivLight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isOpen) {
                    ...
                    ivLight.setImageResource(R.drawable.ic_light_open);
                    isOpen = true;
                } else {
                    CodeUtils.isLightEnable(false);
                    ivLight.setImageResource(R.drawable.ic_light_close);
                    isOpen = false;
                }
            }
        });
